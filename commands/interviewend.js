...
exports.run = async (Discord, client, message, args) => {
  ...
  await roblox.login({username: un, password: pw}).catch(() => {console.log("Failed to login.");});
    ...
    let shoutmessage = "Interviews have just ended, congrats to those who passed! If you failed you can always attended another interview session at 5PM Eastern time or submit an application through our application center!";
